    ...
    return (
        <div className="min-h-screen p-4">
            <div className="container mx-auto max-w-5xl bg-white rounded-lg shadow-lg p-8">
                <h1 className="text-4xl font-extrabold text-purple-900 mb-6">About Us</h1>
                ...
                <div className="text-center mt-8">
                    ...
                    <div className="flex flex-wrap justify-center gap-6">
                        {/* Team Member 1 */}
                        <div className="bg-white shadow-lg rounded-lg overflow-hidden w-55">
                            <img src={myimg} alt="CEO | Kushal Pipaliya" className="w-full h-48 object-cover" />
                            <div className="p-4">
                                <h3 className="text-xl font-semibold text-purple-900">Kushal Pipaliya</h3>
